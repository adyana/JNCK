...
var JNCKToken = artifacts.require("../contracts/JNCKToken.sol");
...
module.exports = async function(deployer) {
    try {
        ...
        if (!contractAddresses.Staking) {
            ...
            await deployer.deploy(Staking, dataParse['JNCKToken'], web3.utils.toBN(stakingConfig.staking_param.rewardPerBlock), startBlock, {
                gas: 3000000
            });
            ...
            if (stakingConfig.staking_param.fund) {
                const tokenInstance = await JNCKToken.at(dataParse['JNCKToken']);
